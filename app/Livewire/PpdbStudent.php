...
class PpdbStudent extends Component
{
    use WithFileUploads;
    ...
    {
        $this->graduation = PpdbPeriod::where('year', $year)->first();
        $this->year = $year;
        $this->loadStudents();
    }
    ...
    {
        $this->students = Applicant::where('ppdb_period_id', $this->graduation->id ?? null)->get();
    }
    ...
    {
        return view('schooling::livewire.ppdb-student');
    }
}
